  ...
  <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="">出库管理</a>
        <a href="${ctx }/stockOuts/page/list">
          <cite>原料出库记录</cite></a>
      </span>
    ...
    <div class="x-body">
      ...
      <%--<table id="list-permission" class="layui-hide"  lay-filter="permissionTableFilter"></table>--%>
        <table class="layui-table" lay-even="true"
               ...
               lay-data="{
                            url: '${ctx}/stockOuts/list' //③数据接口 ,直接去controller
                            ,id: 'stockOutTableId'
                            ,height: 500
        ...
        >
            ...
            <tr>
               ...
               <%-- <th lay-data="{field: 'stockOutId', width:100, sort: true, fixed: 'left'}">ID</th>--%>
                ...
                <th lay-data="{field: 'requestOutNum', width:100}">请求出库数量</th>
                <th lay-data="{field: 'outStorageNum', width:100}">实际出库数量</th>
                <th lay-data="{field: 'outStorageName', width:100}">出库人员</th>
        ...
        <script type="text/html" id="barDemo">
            ...
            <a class="layui-btn layui-btn-xs" lay-event="edit">修改出库信息</a>
                ...
                table.on('tool(permissionTableFilter)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                   ...
                   /*if(layEvent === 'detail'){
                    ...
                    if(layEvent === 'del'){// 删除行
                      ...
                      x_admin_show('状态修改','${ctx}/stockOuts/page/update?id='+data.id);
                      //layer.msg(data.id);
                    }
                });
