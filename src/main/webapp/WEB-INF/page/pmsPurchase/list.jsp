    ...
    <div class="x-body">
      ...
      <%--<table id="list-permission" class="layui-hide"  lay-filter="permissionTableFilter"></table>--%>
        <table class="layui-table" lay-even="true"
               ...
               lay-data="{
                            url: '${ctx}/pmsPurchases/list' //③数据接口 ,直接去controller
                            ,id: 'pmsPurchaseTableId'
                            ,height: 500
            ...
            <tr>
                ...
                <th lay-data="{field: 'rawMatrialId',sort: true, width:100}">物料ID</th> <%--,  fixed: 'left'--%>
                <th lay-data="{field: 'fromOrder', width:150}">对应订单编号</th>
                <th lay-data="{field: 'productName', width:200}">物料名</th>
                <th lay-data="{field: 'contactId', width:100}">合同ID</th>
        ...
        <script type="text/html" id="barDemo">
            ...
            <a class="layui-btn layui-btn-xs" lay-event="edit" data-d="确认入库" onmouseover="show_sth(this)">确认入库</a>
            ...
            layui.use('table', function(){
                ...
                table.on('tool(permissionTableFilter)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                  ...
                  $('#do_search').on('click', function () {
                    ...
                    table.reload('pmsPurchaseTableId', {
                      method: 'get'
                      , where: {
