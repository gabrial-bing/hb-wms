...
<head>
    <meta charset="UTF-8">
    <title>upms通用权限管理系统--添加权限信息</title>
...
<div class="x-body">
    <form class="layui-form" method="POST" id="permissionForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="date" id="inStorageDate" name="inStorageDate" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="">
            </div>
        </div>
        <%--<div class="layui-inline">
            <label for="putInTime" class="layui-form-label">入库时间</label>
            <div class="layui-input-inline">
                <input type="date" class="layui-input" id="putInTime" name="putInTime" required="" lay-verify="required" placeholder="yyyy-MM-dd HH:mm:ss"
                       autocomplete="off" class="layui-input" onmousedown = "s(event, this)" value="">
            </div>
        </div>--%>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.success) {
                        ...
                        layer.alert("添加失败！"+ result.code +": "+result.message);
                    }
                },
